    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 text-center">
        ...
        <div className="relative mb-4">
          <h1 className="text-[100px] font-black leading-none tracking-tight drop-shadow-2xl md:text-[120px]">
            404
          </h1>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <button onClick={() =>{navigate('/')}} className="rounded-2xl bg-white px-8 py-4 text-base font-semibold text-blue-700 shadow-2xl transition-all duration-300 hover:scale-105 hover:bg-white/90">
            Back to Home
          </button>

          <button onClick={() =>{navigate('/contact')}} className="rounded-2xl border border-white/30 bg-white/10 px-8 py-4 text-base font-semibold text-white backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-white/20">
            Contact Support
          </button>
        </div>
